...
{   cleardevice();
    ...
    outtextxy(600, 100, " Bine ai venit! ");
...
{   cleardevice();
    ...
    outtextxy(100,130,"     Cand am auzit prima data de numele proiectului nostru, BIBLIS, primul gand ne-a purtat catre");
    outtextxy(100,160,"Sfanta Biblie. Ne intrebam oare la ce se refera acest proiect, avem oare de descifrat intelesurile");
    outtextxy(100,190,"ascunse ale Bibliei? Sau poate sa proiectam un algoritm care citeste si exemplifica grafic fiecare");
    outtextxy(100,220,"pilda din Cartea Sfanta. Daca acest gand ar fi fost real, probabil si acum am fi stat sa desenam");
    outtextxy(100,250,"fiecare pietricica din Ierusalim.");
    outtextxy(100,280,"     Ne-am calmat si am decis sa ne documentam pe internet mai mult, sa aflam ce este mai exact");
    outtextxy(100,310,"Biblia. Am lecturat cateva pagini bune pana cand am realizat ca poate ar trebui sa ne oprim. Primul ");
    outtextxy(100,340,"gand nu a fost prea de ajutor, proiectul nostru nu se referea nicicum la Noul sau Vechiul Testament,");
    outtextxy(100,370,"dar pentru ca a noastra cautare sa nu fie de prisos, iata cateva un fun fact gasit pe internet:");



    outtextxy(520,420,"     Biblia se refera la Scripturile sacre din iudaism si crestinism. Pentru evreii credinciosi,");
    outtextxy(520,450,"Biblia consta din Vechiul Testament (o versiune a Bibliei ebraice) impreuni cu Noul Testament.");
    outtextxy(520,480,"Biblia este cea mai raspandita carte din lume.");
    outtextxy(520,510,"     Scrierile din Biblia ebraica sunt compilatii ale unor documente separate (numite carti),");
    outtextxy(520,540,"scrise intr-un interval de timp de circa 1000 de ani.Istoricii Bibliei considera ca Biblia ebraica ");
    outtextxy(520,570,"este rezultatul activitatii a circa 100-150 scriitori diferiti provenind din carturarii aflati in ");
    outtextxy(520,600,"serviciul conducatorilor politici si clericali din regatele Israelului si Iudeei antice.");
    ...
    {
        mciSendString ("play sunet.mp3", NULL, 0, NULL);sunet();;    //SUNET LA APASAREA BUTONULUI
        descriereProiect2();
    }
    else
...
{   cleardevice();
    ...
    outtextxy(500,50,"PROIECTUL BIBLIS");
    settextstyle(3, HORIZ_DIR,3);
    outtextxy(370,140,"     Al doilea gand a fost direct sa cautam pe internet cuvantul Biblis. Rezultatul ne-a surprins putin, am gasit");
    outtextxy(370,170,"Biblis ca fiind o comuna din  landul Hessa, Germania. Cu o arhitectura frumoasa, Biserica Sf. Bartolomeu dateaza");
    outtextxy(370,200,"din anul 1865. Biserica inaintasa a devenit prea mica pentru populatie, care a crescut brusc. Planurile pentru ");
    outtextxy(370,230,"actuala biserica au fost intocmite de maestrul cladirii districtului Marelui Ducat al Hesse-ului Christian Horst.");
    outtextxy(370,260,"El a proiectat biserica ca pe o basilica neo-gotica timpurie, cu trei nave, pe coloana, cu cor si transept");
    outtextxy(370,290,"dupa modelul Bisericii Elisabeta din Marburg. In fiecare an, in iunie, Gurkenfest(Festivalul Castravetilor) este ");
    outtextxy(370,320,"deschis de catre Gurkenkanigin (Regina de castraveti) pentru bucuria populatiei locale si a vizitatorilor.");

    outtextxy(100,470,"     Biblis are Centrala Nucleara Biblis, situata pe raul Rin, cu doua blocuri de reactoare");
    outtextxy(100,500,"cu apa sub presiune - Biblis A si Biblis B. Impreuna, blocurile produc o putere de 2 500");
    outtextxy(100,530," MW.Blocul A a intrat in functiune in 1974 si Blocul B in 1976. ");
    outtextxy(100,560,"     La momentul deschiderii, Biblis era cea mai mare centrala nucleara din lume si ");
    outtextxy(100,590,"o etapa  importanta in generarea de energie electrica.");
...
void descriereAutori()
{
    ...
    settextstyle(3, HORIZ_DIR, 4);  // SELECTAREA STILULUI DE SCRIS,HORIZ_DIR (Left to right) SAU VERT_DIR (Bottom to top),
    ...
    do
    {
        if (ismouseclick(WM_LBUTTONDOWN))
        {
            ...
            x = mousex();
            y = mousey();
                if(x >= 625 && x <= 775 && y >=640  && y <= 670)   // BUTON PENTRU PAGINA PRECEDENTA ADICA MENIUL PRINCIPAL
                {
                    gata=true;
                    inapoi = true;
                }
